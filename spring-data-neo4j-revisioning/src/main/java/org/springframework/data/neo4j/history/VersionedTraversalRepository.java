...
public interface VersionedTraversalRepository<T> extends TraversalRepository<T> {
    <N> Iterable<T> findAllByTraversal(N startNode, VersionedTraversalDescription traversalDescription);
}
